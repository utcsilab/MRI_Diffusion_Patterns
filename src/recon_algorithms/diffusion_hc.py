...
class Diffusion_HC:
    def __init__(self, net, hard_consistent_output,
                 steps, rho, S_churn, S_min, S_max, S_noise, sigma_min, sigma_max):
        """
        Class that performs MRI reconstruction using repaint/hard consistency in k-space.
    ...
    def __call__(self, x_init, FSx, P, S):
        """
        Performs performs MRI reconstruction using repaint/hard consistency in k-space.
